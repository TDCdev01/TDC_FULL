    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gray-800 rounded-xl shadow-xl border border-gray-700">
          <form id="blog-form" onSubmit={handleSubmit} className="divide-y divide-gray-700">
            {/* Title Section */}
            <div className="p-8">
              <div className="flex items-center justify-between group">
                {isEditingTitle ? (
                  <input
                    ...
                    autoFocus
                    className="w-full text-4xl font-bold text-white border-b-2 border-purple-500 focus:outline-none bg-gray-700 px-2 py-1 rounded"
                    placeholder="Enter your post title..."
                  />
                ) : (
                  <h2 
                    className="text-4xl font-bold text-white px-2 py-1"
                  >
                    {title}
                  </h2>
                )}
                <button
                  ...
                  className="ml-4 p-2 text-gray-400 hover:text-purple-400 rounded-full hover:bg-gray-700 transition-colors opacity-0 group-hover:opacity-100"
                >
                  {isEditingTitle ? (
            ...
            <div className="p-8">
              <label className="block text-sm font-medium text-gray-300 mb-2">
                ...
                className="w-full px-4 py-2 bg-gray-700 text-white placeholder-gray-400 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
