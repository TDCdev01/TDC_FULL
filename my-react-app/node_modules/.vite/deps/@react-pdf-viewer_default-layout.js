...
var require_bookmark = __commonJS({
  "node_modules/@react-pdf-viewer/bookmark/lib/cjs/bookmark.js"(exports) {
    ...
    var BookmarkItem = function(_a) {
      ...
      var defaultExpanded = isBookmarkExpanded ? isBookmarkExpanded({ bookmark, doc, depth, index }) : !defaultIsCollapsed;
      ...
      var toggleSubItems = function() {
        return setExpanded(function(expanded2) {
          return !expanded2;
        });
      };
      ...
      return React__namespace.createElement(
        ...
        React__namespace.createElement(
          "div",
          { className: "rpv-bookmark__item", style: {
        ...
        hasSubItems && expanded && React__namespace.createElement(BookmarkList, { bookmarks: bookmark.items, depth: depth + 1, doc, isBookmarkExpanded, isRoot: false, store, onJumpToDest })
      );
    };
    var BookmarkList = function(_a) {
      ...
      return React__namespace.createElement("ul", { className: "rpv-bookmark__list", role: isRoot ? "tree" : "group", tabIndex: -1 }, bookmarks.map(function(bookmark, index) {
        return React__namespace.createElement(BookmarkItem, { bookmark, depth, doc, index, isBookmarkExpanded, key: index, numberOfSiblings: bookmarks.length, store, onJumpToDest });
      }));
    };
    var Toggle;
    (function(Toggle2) {
    ...
    var BookmarkListRoot = function(_a) {
      ...
      var updateLinkAnnotation = function(bookmark, links2) {
        var dest = bookmark.dest;
        if (!dest || typeof dest !== "string" || !links2[dest]) {
          return;
        }
        var annotationContainer = links2[dest];
        ...
        bookmark.items.forEach(function(item) {
          return updateLinkAnnotation(item, links2);
        });
      };
      var handleLinkAnnotationsChanged = function(links2) {
        return setLinks(links2);
      };
      ...
      return React__namespace.createElement(
        "div",
        { ref: containerRef },
        React__namespace.createElement(BookmarkList, { bookmarks, depth: 0, doc, isBookmarkExpanded, isRoot: true, store, onJumpToDest: jumpToDest })
      );
    };
    var BookmarkLoader = function(_a) {
      ...
      return !bookmarks.isLoaded ? React__namespace.createElement(
        ...
        React__namespace.createElement(BookmarkListRoot, { bookmarks: bookmarks.items, doc, isBookmarkExpanded, store, onJumpToDest })
      );
    };
    var BookmarkListWithStore = function(_a) {
      ...
      return currentDoc ? React__namespace.createElement(BookmarkLoader, { doc: currentDoc, isBookmarkExpanded, store, onJumpToDest: jump }) : React__namespace.createElement(
        "div",
        { className: "rpv-bookmark__loader" },
        React__namespace.createElement(core.Spinner, null)
      );
    ...
    var bookmarkPlugin = function() {
      ...
      var BookmarksDecorator = function(props) {
        return React__namespace.createElement(BookmarkListWithStore, { isBookmarkExpanded: props === null || props === void 0 ? void 0 : props.isBookmarkExpanded, store });
      };
...
var require_thumbnail = __commonJS({
  "node_modules/@react-pdf-viewer/thumbnail/lib/cjs/thumbnail.js"(exports) {
    ...
    var CoverInner = function(_a) {
      ...
      return src ? React__namespace.createElement("img", { className: "rpv-thumbnail__cover-image", "data-testid": "thumbnail__cover-image", src }) : React__namespace.createElement("div", { className: "rpv-thumbnail__cover-loader", "data-testid": "thumbnail__cover-loader", ref: containerRef }, renderSpinner ? renderSpinner() : React__namespace.createElement(core.Spinner, null));
    };
  ...
  "node_modules/@react-pdf-viewer/print/lib/cjs/print.js"(exports) {
    ...
    var PageThumbnail = function(_a) {
      ...
      return src && React__namespace.createElement(
        ...
        React__namespace.createElement("img", { src, onLoad: function() {
          return onLoad();
        } })
      );
    };
    var PageThumbnailContainer = function(_a) {
      ...
      var rotationNumber = (pageSize.viewportRotation + rotation + pageRotation) % 360;
      return page && React__namespace.createElement(PageThumbnail, { canvas, page, pageHeight: isVertical ? height : width, pageWidth: isVertical ? width : height, rotation: rotationNumber, onLoad });
    };
    var PrintZone = function(_a) {
      ...
      return reactDom.createPortal(React__namespace.createElement(
        React__namespace.Fragment,
        null,
        Array(Math.min(numLoadedPages + 1, doc.numPages)).fill(0).map(function(_, index) {
          return React__namespace.createElement(PageThumbnailContainer, { key: index, canvas, doc, pageHeight, pageIndex: index, pageRotation: pagesRotation.has(index) ? pagesRotation.get(index) : 0, pageWidth, rotation, onLoad });
        }),
    ...
    var PrintContainer = function(_a) {
      ...
      return React__namespace.createElement(
        ...
        (printStatus === PrintStatus.Preparing || printStatus === PrintStatus.Ready) && numLoadedPagesForPrint <= doc.numPages && React__namespace.createElement(PrintZone, { doc, numLoadedPages: numLoadedPagesForPrint, pagesRotation, pageHeight, pageWidth, printStatus, rotation, onCancel: cancelPrinting, onLoad: onLoadPage })
      );
    };
      ...
      var renderViewer = function(props2) {
        ...
        var updateSlot = {
          children: React__namespace.createElement(
            React__namespace.Fragment,
            null,
            printPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, { containerRef: props2.containerRef, store }),
            React__namespace.createElement(PrintContainer, { doc: props2.doc, pagesRotation: props2.pagesRotation, pageHeight: props2.pageHeight, pageWidth: props2.pageWidth, rotation: props2.rotation, store }),
            slot.children
          )
        };
        return __assign(__assign({}, slot), updateSlot);
  ...
  "node_modules/@react-pdf-viewer/scroll-mode/lib/cjs/scroll-mode.js"(exports) {
    ...
    var SwitchScrollModeButton = function(_a) {
      ...
      return React__namespace.createElement(SwitchScrollModeDecorator, { mode, onClick }, function(props) {
        return React__namespace.createElement(core.Tooltip, { ariaControlsSuffix: "scroll-mode-switch", position: core.Position.BottomCenter, target: React__namespace.createElement(core.MinimalButton, { ariaLabel: props.label, isSelected, testId, onClick: props.onClick }, props.icon), content: function() {
          return props.label;
        }, offset: TOOLTIP_OFFSET });
      });
    };
  ...
  "node_modules/@react-pdf-viewer/search/lib/cjs/search.js"(exports) {
    ...
    var searchPlugin = function(props) {
      ...
      var renderPageLayer = function(renderProps) {
        return React__namespace.createElement(Tracker, { key: renderProps.pageIndex, numPages: renderProps.doc.numPages, pageIndex: renderProps.pageIndex, store, onHighlightKeyword: searchPluginProps.onHighlightKeyword });
      };
      return {
        install: function(pluginFunctions) {
